...
There is no catch-all redirect — visitors from uncovered countries stay
on the current host (pass through). Country codes must not overlap across domains (behaviour is
